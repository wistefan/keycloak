 ...
 * implementation.
 */
public class OIDC4VPLoginProtocol implements LoginProtocol {

	public OIDC4VPLoginProtocol(KeycloakSession session) {
	}

	@Override public OIDC4VPLoginProtocol setSession(KeycloakSession session) {
		return this;
	}

	@Override public OIDC4VPLoginProtocol setRealm(RealmModel realm) {
		return this;
	}
	...
	@Override
	public OIDC4VPLoginProtocol setEventBuilder(EventBuilder event) {
		return this;
	}
